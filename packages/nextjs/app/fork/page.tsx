        ...
        <div className="px-5 max-w-3xl w-full">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg opacity-70 mt-3 max-w-xl">
              The ZK credit system is designed to be forked. The core is
              token-agnostic. CLAWD is just our implementation on top. Deploy
              your own in minutes.
            </p>
          </div>
                  ...
                  <div>
                    <h3 className="text-lg font-bold">
                      ...
                      <span className="text-xs font-normal opacity-50 ml-2">
                        — the forkable primitive
                      </span>
                    </h3>
                    <p className="text-sm opacity-70 mt-1">
                      ZK Merkle tree + ERC-20 staking. No opinion on token,
                      price, or payment method. Accepts any ERC-20 set at deploy
                      time. Static{" "}
                      <code className="bg-base-300 px-1 rounded text-xs">
                        pricePerCredit
                      </code>{" "}
                      via constructor. This is what you deploy.
                    </p>
                    <div className="mt-3 font-mono text-xs opacity-60 space-y-0.5">
                      ...
                      <p>├─ claimServer()</p>
                      <p>
                        └─ Poseidon2 Merkle tree (Semaphore-style, 16 levels,
                        65k leaves)
                      </p>
                    </div>
                  </div>
              ...
              <div className="border border-base-content/10 rounded-lg p-5 opacity-80">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-70 mt-1">
                      30-minute Uniswap v3 TWAP on the WETH/CLAWD pool +
                      Chainlink ETH/USD with owner-set fallback. Returns
                      USD-pegged pricing in CLAWD terms. Swap this out for your
                      own pricing.
                    </p>
                    <div className="mt-3 font-mono text-xs opacity-60 space-y-0.5">
              ...
              <div className="border border-base-content/10 rounded-lg p-5 opacity-80">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-70 mt-1">
                      Accepts ETH, USDC, or CLAWD directly. Swaps non-CLAWD
                      payments to CLAWD via Uniswap v3, then calls
                      APICredits.stakeAndRegister(). Replace with your own
                      router for your own token and payment flow.
                    </p>
                    <div className="mt-3 font-mono text-xs opacity-60 space-y-0.5">
                      <p>├─ buyWithCLAWD()</p>
...
cd packages/api-server && yarn start`}
            ...
            <p className="text-sm opacity-50 mt-3">
              That&apos;s it. You don&apos;t need CLAWDPricing or CLAWDRouter
              unless you want USD-pegged dynamic pricing or multi-asset
              payments. APICredits works standalone with a fixed price in your
              token.
            </p>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  [
                    "ZK Circuit",
                    "Noir + UltraHonk. Commitment, Merkle proof, nullifier derivation.",
                  ],
                  [
                    "Privacy Model",
                    "Poseidon2 commitments, unlinkable nullifiers, anonymity set = tree size.",
                  ],
                  [
                    "API Server",
                    "Proof verification, nullifier tracking, historical root cache.",
                  ],
                  [
                    "Merkle Tree",
                    "Semaphore-style incremental tree, 16 levels, Poseidon2 hashing.",
                  ],
                ].map(([title, desc]) => (
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  [
                    "Pricing",
                    "Fixed, TWAP, auction, governance vote — anything.",
                  ],
                  [
                    "Payment Methods",
                    "ETH, USDC, x402, credit card, whatever you build.",
                  ],
                  [
                    "Inference Provider",
                    "Venice, OpenAI, Anthropic, local model — swap the API URL.",
                  ],
                  [
                    "Credit Tiers",
                    "Different prices for different models or usage levels.",
                  ],
                ].map(([title, desc]) => (
                  <li key={title} className="flex items-start gap-2">
...
└──────┬──────┘     └──────┬───────┘     └──────┬───────┘
       ...
       │                                        │`}
            ...
            <p className="text-xs opacity-40 mt-2 font-mono">
              Step 1 requires a wallet. Steps 2-8 are anonymous — no wallet, no
              identity.
            </p>
          </div>

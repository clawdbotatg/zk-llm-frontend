...
const Home: NextPage = () => {
  ...
  const [apiCreditsAddress, setApiCreditsAddress] = useState<
    `0x${string}` | undefined
  >(undefined);
      ...
      <div className="relative z-10">
        <div className="max-w-5xl mx-auto px-6 pt-24 pb-32">
          ...
          <h1 className="text-6xl md:text-7xl font-mono font-bold leading-none mb-8 tracking-tight">
            ...
            No identity.
            <br />
            <span className="text-4xl md:text-5xl text-base-content/50">
              Hella forkable.
            </span>
          </h1>
          ...
          {/* How it works */}
          <div className="mb-20">
            <p className="text-xs font-mono text-base-content/30 mb-8 tracking-widest">
              HOW IT WORKS
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[#333] bg-black/80 backdrop-blur-sm">
              {[
                ...
                >
                  ...
                  <h3 className="font-mono font-bold text-base mb-3">
                    {title}
                  </h3>
                  <p className="text-sm font-mono text-base-content/50 leading-relaxed">
                    {body}
                  </p>
                </div>
              ))}
    ...
    "messages": [{"role": "user", "content": "Hello"}]
          ...
          <div className="flex flex-wrap gap-8 text-xs font-mono text-base-content/50 bg-black/60 backdrop-blur-sm px-4 py-3 border border-[#333]">
            ...
            <a
              href={
                apiCreditsAddress
                  ? `https://basescan.org/address/${apiCreditsAddress}`
                  : "#"
              }
              target="_blank"
              rel="noopener noreferrer"
